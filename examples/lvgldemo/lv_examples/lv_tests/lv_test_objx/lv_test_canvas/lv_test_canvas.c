...
void lv_test_canvas_1(void)
{
    ...
    lv_color_t *cbuf_tmp = (lv_color_t *)lv_mem_alloc(LV_CANVAS_BUF_SIZE_TRUE_COLOR(CANVAS_WIDTH, CANVAS_HEIGHT));
    memcpy(cbuf_tmp, cbuf, LV_CANVAS_BUF_SIZE_TRUE_COLOR(CANVAS_WIDTH, CANVAS_HEIGHT));
    lv_img_dsc_t img;
